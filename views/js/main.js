...
var resizePizzas = function(size) {
  ...
  //Changes:
  //getElementsByClassName faster than querySelectorAll- see
...
//Changes:
//Moved the following line outside for loop because don't need to define more than once
var pizzasDiv = document.getElementById("randomPizzas");
//Changes:
//Tells the browser that want to perform animation and requests a specified
//function to update an animation before the next repaint
window.requestAnimationFrame(function animator(){
// This for-loop actually creates and appends all of the pizzas when the page loads
//Change:Apppend less pizzas
for (var i = 2; i < 30; i++) {
...
function updatePositions() {
  ...
  //Change: Take out static calculation outside for loop
